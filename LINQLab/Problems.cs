...
namespace LINQLab
{
    class Problems
    {
        ...
        private void RProblemOne()
        {
            ...
            Console.WriteLine("RProblemOne user count");
      ...
      */
        ...
        public void RProblemTwo()
        {
            ...
            var pricePoint100 = _context.Products.Where(p => p.Price <= 100);
            Console.WriteLine("RProblemTwo");
            foreach (Product product in pricePoint100)
            {
                Console.WriteLine($"{product.Name} - ${product.Price}");
